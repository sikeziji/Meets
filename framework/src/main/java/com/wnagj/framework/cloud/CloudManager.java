package com.wnagj.framework.cloud;

import android.content.Context;
import android.net.Uri;
import android.widget.Toast;

import com.wnagj.framework.R;
...
public class CloudManager {
    ...
    //Key
    public static final String CLOUD_KEY = "x18ywvqfx4nsc";
    public static final String CLOUD_SECRET = "fF3Ygav6rmSMNa";
    ...
    public void connect(String token) {
        ...
        RongIMClient.connect(token, new RongIMClient.ConnectCallback() {
            ...
            public void onSuccess(String s) {
                ...
                //测试使用
//                CloudManager.getInstance().sendTextMessage("很高兴认识你", "2dece61d35");
