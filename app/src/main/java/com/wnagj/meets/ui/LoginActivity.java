...
import com.wnagj.framework.view.TouchPictureV;
...
public class LoginActivity extends BaseUIActicity {
    ...
    @OnClick({R.id.btn_send_code,R.id.btn_login,R.id.tv_test_login})
